                                    ...
                                    <?php 
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="pdf-mis.php?ay=<?=$row['sy']?>&semester=<?=$row['semester']?>&section=<?=$row['section']?>" target="_blank" class="status text-warning" ><i class="material-icons"  title="Status">&#xe415;</i></a>
                                            </td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>

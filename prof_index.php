                                            ...
                                            <div class="row">
                                                ...
                                                <div class=" col">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="profMname" class="form-control" value="<?php echo $profLname; ?>">
                                                    </div>
                                                </div>
                                                <div class="col">
                                                    <div class="form-group">
                                                        <label>Last Name</label>
                                                        <input type="text" name="profLname" class="form-control" value="<?php echo $profMname; ?>">
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" name="profEmployStatus">
                                                            ...
                                                            <option id="profPart" value="Part-Time" <?= ($profEmployStatus == "Part-Time") ? "selected" : ""; ?>>Part-Time</option>
                                                            <option id="profFull" value="Full-Time" <?= ($profEmployStatus == "Full-Time") ? "selected" : ""; ?>>Full-Time</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
